"""
Web application for CrimsonVC Studio.
...
from ultimate_rvc.branding import APP_NAME
...
from ultimate_rvc.web.presentation import (
    hero_html,
    load_app_styles,
    runtime_status_html,
)
...
def _init_dropdowns() -> list[gr.Dropdown]:
    """
    Initialize CrimsonVC Studio by updating the choices
