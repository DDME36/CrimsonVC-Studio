...
The launcher for CrimsonVC Studio.

.DESCRIPTION

This script is the entry point for CrimsonVC Studio. It is responsible for installing dependencies,
...
update:    Update CrimsonVC Studio to the latest version.
uninstall: Uninstall dependencies and user generated data.
run:       Start CrimsonVC Studio.
dev:       Start CrimsonVC Studio in development mode.
cli:       Start CrimsonVC Studio in CLI mode.
